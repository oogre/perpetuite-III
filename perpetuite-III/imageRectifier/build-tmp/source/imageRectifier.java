...
public class imageRectifier extends PApplet {
...
public Pair<Integer, Integer> decompose(int v) {
...
public class Triple<A, B, C> {
    ...
    public Triple(final A x, final B y, final C z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "imageRectifier" };
    if (passedArgs != null) {
