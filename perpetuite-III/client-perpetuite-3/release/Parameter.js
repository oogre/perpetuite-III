...
class Parameter {
  ...
  static fromRawType(key, value) {
    switch (key) {
      case "i":
        return Parameter.fromInt(value);

      case "f":
        return Parameter.fromFloat(value);

      case "d":
        return Parameter.fromDouble(value);

      case "b":
        return Parameter.fromBool(value);
  ...
  static fromBool(value) {
    return new Parameter(PARAMETER_TYPE.Bool, (0, _Tools.stringToBoolean)(value));
  }
  ...
  static fromPosition(value) {
    return [new Parameter(PARAMETER_TYPE.Double, value.x), new Parameter(PARAMETER_TYPE.Double, value.y), new Parameter(PARAMETER_TYPE.Double, value.z), new Parameter(PARAMETER_TYPE.Double, value.w)];
  }
