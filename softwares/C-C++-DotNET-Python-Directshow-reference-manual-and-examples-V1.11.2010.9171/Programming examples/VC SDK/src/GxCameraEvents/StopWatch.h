// High performance time measurement tool
class CStopWatch
{	
public:
    ...
    ///Stop. The elapsed time in seconds is returned. The stop watch may be started again	
...
protected:
    ...
    LARGE_INTEGER m_StartTime;  ///< zero-point for time measurment 
    LARGE_INTEGER m_StopTime;   ///< last time stamp 
};
