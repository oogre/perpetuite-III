...
# ADD CPP /nologo /MT /W3 /GX /I "../../inc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /Yu"stdafx.h" /FD /c
...
# ADD LINK32 GxIAPI.lib DxImageProc.lib /nologo /subsystem:windows /machine:I386 /out:"../../bin/x86/GxCameraEvents.exe" /libpath:"..\..\lib\x86" /OPT:NOREF
...
# ADD LINK32 GxIAPI.lib DxImageProc.lib /nologo /subsystem:windows /debug /machine:I386 /out:"../../bin/x86/GxCameraEvents.exe" /pdbtype:sept /libpath:"..\..\lib\x86"
